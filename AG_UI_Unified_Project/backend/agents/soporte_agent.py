...
def custom_user_extractor(run_input: ag_ui.core.types.RunAgentInput) -> str:
    # CopilotKit properties arrive in forwarded_props
    props = run_input.forwarded_props or {}
    return props.get("userEmail", "anonymous_luma_user")
